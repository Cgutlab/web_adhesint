...
@section('titulo', 'Crear Contenido Servicio')
...
<main>
	<div class="container">
		...
		<div class="row">
			<div class="col s12">
			{!!Form::open(['route'=>'servcontenido.store', 'method'=>'POST', 'files' => true])!!}
{{-- 				<div class="row">
				...
				<div class="col s12 no-padding">
					{!!Form::submit('Crear', ['class'=>'disabled waves-effect waves-light btn right '])!!}
				</div>
			{!!Form::close()!!} 
		</div>
		</div>
