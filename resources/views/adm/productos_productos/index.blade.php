	...
	<div class="container">
		...
		<div class="row">
			<div class="col s12">
				<div class="row">
					<div class="left">
						<a href="{{ route('productos_productos.create', $categoria->id) }}"><i title="Agregar" class="material-icons medium">add_circle</i></a>
					</div>
					<div class="right">
				...
				<table class="highlight bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-right">
								<a href="{{ route('productos_productos.edit',$categoria->id) }}"><i title="Editar" class="material-icons">create</i></a>
								{!!Form::open(['class'=>'en-linea', 'route'=>['productos_productos.destroy', $categoria->id], 'method' => 'DELETE'])!!}
