	...
	<div class="container">
		...
		<div class="row">
			<div class="col s12">
				<div class="row">
					<div class="right">
						<a href="{{ route('productos_productos.lists',$categoria->id) }}" class="right"><i title="Regresar" class="material-icons">backspace</i></a>
					</div>
					<div class="center-align">
						{{$categoria->titulo}}
					</div>
				</div>
				{!!Form::open(['route'=>'productos_productos.store', 'method'=>'POST', 'files' => true])!!}
				...
				<div class="row">
					...
					<div class="input-field col l6 s12">
						...
						<select name="presentaciones[]" class="form-control" multiple="true">
						@foreach($presentaciones as $presentacion)
							<option value="{{$presentacion->id}}">{{$presentacion->titulo}} - {{$presentacion->peso}}</option>
						@endforeach
						</select>
					</div>
				</div>
