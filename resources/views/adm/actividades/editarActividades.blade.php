		...
		<div class="row">
          ...
          <td>Orden</td>
            ...
            <td>{!! $actividad->orden !!}</td>
						<td class="text-right">
							<a href="{{ route('actividades.edit',$actividad->id) }}"><i title="Editar" class="material-icons">create</i></a>
							{!!Form::open(['class'=>'en-linea', 'route'=>['actividades.destroy', $actividad->id], 'method' => 'DELETE'])!!}
