			...
			{!!Form::model($video, ['route'=>['videos.update', $video->id], 'method'=>'PUT', 'files' => true])!!}
					...
					<div class="file-field input-field col s8">
						    ...
						    <div class="file-path-wrapper">
						      	{!! Form::text('',$video->imagen, ['class'=>'file-path validate', 'placeholder'=>'Recomendado (20 X 20) Pixels']) !!}
						    </div>
						</div>
					</div> --}}
					<div class="row">
	          <div class="input-field col s8">
	            ...
	            {!!Form::text('video',$video->video,['class'=>'validate', 'required'])!!}
							<small>Inserte solo el código: -> https://youtube.com/watch?v=<b style="color: red;">E4AGcdSFs4I</b></small>
	          </div>
						<div class="input-field col s4">
							{!!Form::label('Orden')!!}
							{!!Form::text('orden',$video->orden,['class'=>'validate', 'required'])!!}
						</div>
					</div>
