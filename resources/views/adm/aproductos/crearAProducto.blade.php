...
<main>
	<div class="container">
		...
		<div class="row">
			<div class="col s12">
			{!!Form::open(['route'=>'aproducto.store', 'method'=>'POST', 'files' => true])!!}
		<div class="row">
        ...
        <div class="row">
				...
				<div class="row">
					<div class="input-field col s12">
						{!!Form::label('Breve')!!}
						{!!Form::textarea('breve', null, ['class'=>'validate', 'cols'=>'74', 'rows'=>'5', ])!!}
					</div>
				</div>
				<div class="row">
					<div class="input-field col s12">
          ...
          <div class="input-field col s2">
            ...
            <select name="id_categoria" style="display: inherit;">
	            @foreach($acategorias as $acategoria)
	                  <option value="{{$acategoria->id}}">{{$acategoria->titulo}}</option>
	            @endforeach
	        </select>
          </div>
