	...
	<div class="container">
		...
		<div class="row">
			<div class="col s12">
				<div class="row">
					<div class="right">
						<a href="{{ route('aplicaciones_productos.lists',$producto->id_categoria) }}" class="right"><i title="Regresar" class="material-icons">backspace</i></a>
					</div>
				</div>
				{!!Form::model($producto, ['route'=>['aplicaciones_productos.update', $producto->id], 'method'=>'PUT', 'files' => true])!!}
				...
				<div class="row">
					<div class="input-field col l6 s12">
						...
						{!! Form::select('relacionados[]', $relacionados, $producto->relacionados, ['class' => 'form-control', 'multiple' => 'multiple']) !!}
					</div>
				</div>
